...
// import { useAccount, useContractWrite, usePrepareContractWrite } from "wagmi";
// import { rawEmailToBuffer } from "@zk-email/helpers/dist/input-helpers";
// import { downloadProofFiles, verifyProof } from "@zk-email/helpers/dist/zkp";
// import { abi } from "../abi.json";
// import { generateTwitterVerifierCircuitInputs, ITwitterCircuitInputs } from "@proof-of-twitter/circuits/helpers";
// import { LabeledTextArea } from "../components/LabeledTextArea";
// import DragAndDropTextBox from "../components/DragAndDropTextBox";
// import { SingleLineInput } from "../components/SingleLineInput";
// import { Button, TextButton } from "../components/Button";
...
// import { ProgressBar } from "../components/ProgressBar";
// import useGoogleAuth from "../hooks/useGoogleAuth";
// import { RawEmailResponse, fetchEmailList, fetchEmailsRaw } from "../hooks/useGmailClient";
// import { formatDateTime } from "../helpers/dateTimeFormat";
// import EmailInputMethod from "../components/EmailInputMethod";
// import { Box, Grid, Typography } from "@mui/material";
// import Stepper from '../components/Stepper'
...
//   const [showBrowserWarning, setShowBrowserWarning] = useState<boolean>(false);
//   const [downloadProgress, setDownloadProgress] = useState<number>(0);
//   const [inputMethod, setInputMethod] = useState<"GOOGLE" | "EML_FILE" | null>();
//   const [status, setStatus] = useState<
//     | "not-started"
//     | "generating-input"
//     | "downloading-proof-files"
...
//   const handleProofGeneration = async (input) => {
//     // Use new URL syntax with the correct path and module type
//     const worker = new Worker(new URL('./proofWorker.js', import.meta.url), { type: 'module' });
  
//     worker.postMessage({
//       input,
//       circuitArtifactsUrl: import.meta.env.VITE_CIRCUIT_ARTIFACTS_URL,
...
//       {isOverlayVisible && <Overlay>Processing...</Overlay>}
//       <Grid item xs={12} md={6} container sx={{backgroundColor:'#ffbfbf', background:'radial-gradient(70.71% 70.71% at 50% 50%, #FFF 19%, rgba(255, 255, 255, 0.00) 61%), linear-gradient(38deg, rgba(255, 255, 255, 0.00) 60%, rgba(255, 255, 255, 0.69) 100%), linear-gradient(45deg, #FFF 10%, rgba(255, 255, 255, 0.00) 23.5%), linear-gradient(36deg, #FFF 12.52%, rgba(255, 255, 255, 0.00) 76.72%), linear-gradient(214deg, rgba(255, 255, 255, 0.00) 0%, rgba(255, 220, 234, 0.40) 37.53%, rgba(255, 255, 255, 0.00) 71%), linear-gradient(212deg, rgba(255, 255, 255, 0.00) 15%, #E4F1FE 72.5%, rgba(255, 255, 255, 0.00) 91.5%)'}}>
//         <Nav splitscreen={true}/>
//         <Box sx={{ paddingX: {xs:'30px', sm:'60px'}, color: '#000000', minHeight: '650px' }}>
...
//         <Typography sx={{ color: '#ffffff' }}>HERE IS WHERE WE WILL PUT THE INSTRUCTION STEP VIDEO OR PICTURES ON THE RIGHT SIDE </Typography>
//         {activeStep == 0 && (
//           <Typography sx={{ color: '#ffffff' }}>video/graphic for step 0</Typography>
//         )}
//         {activeStep == 1 && (
//           <Typography sx={{ color: '#ffffff' }}>video/graphic for step 1</Typography>
//         )}
//         {activeStep == 2 && (
//           <Typography sx={{ color: '#ffffff' }}>video/graphic for step 2</Typography>
//         )}
//         {activeStep == 3 && (
//           <Typography sx={{ color: '#ffffff' }}>video/graphic for step 3</Typography>
//         )}
//         {activeStep == 4 && (
//           <Typography sx={{ color: '#ffffff' }}>video/graphic for step 4</Typography>
//         )}
//         {/* <Video /> */}
//       </Grid>
//     </Grid>
