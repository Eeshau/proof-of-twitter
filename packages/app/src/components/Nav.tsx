...
//               color: '#ffffff',
//               padding: {xs: '7px 10px', sm:'10px 16px'},
//               borderRadius: '10px',
//               cursor: 'pointer',
//               '&:hover': {
...
//                   <Typography variant="body2" sx={{ color: '#ffffff', fontSize: {xs: '7px', sm: '10px', md: '12px'} }}>
...
//                       }}
//                     />
//                     <Typography variant="body2" sx={{ color: '#ffffff', paddingX: '3px', fontSize: {xs: '7px', sm: '10px', md: '12px'}}}>
//                       {account.displayName}
//                     </Typography>
//                   </Box>
//                 </Box>
...
// const Nav = () => {
//   return (
//     <Box display='flex' justifyContent='space-between' alignContent='center' alignItems='center' width='100%' sx={{paddingX: '20px', paddingY: {xs: '15px', sm: '20px'}, backgroundColor: '#ffffff', borderBottom: '1px solid #D9D9D9' }}>
//       <Link to={"/"}>
...
//       <Box display='flex' justifyContent='space-between' alignContent='center' alignItems='center' sx={{marginRight: {xxs: '10px', xs: '30px', sm: '40px', md: '50px'}, gap: {xxs: '0px', xs: '5px', sm: '50px'} }}>
//         <Link to="https://prove.email/docs" target="_blank"><Typography sx={{ display: { xs: 'none', sm: 'block' }, fontSize: { xs: '12px', md: '14px' } }}>Docs</Typography></Link>
//         <Link to="https://prove.email/docs" target="_blank"><Typography sx={{ display: { xs: 'none', sm: 'block' }, fontSize: { xs: '12px', md: '14px' } }}>Explore</Typography></Link>
//         <CustomConnectButton />
//       </Box>
//     </Box>
//   );
...
/* STYLED CONNECT WALLET BUTTON */
const CustomConnectButton = ({ splitscreen }) => {
  const theme = useTheme();
  return (
    <ConnectButton.Custom>
      {({
